...
const Home = () => {
  ...
  return (
    <>
       <Header/> 
        <HomeText> 
         <p style={{fontSize: "35px", fontWeight: "800", margin: "0"}}>FACULTY OF COMPUTING AND INFORMATION TECHNOLOGY</p>
         <p style={{fontSize: "25px", margin: "10px"}}>GODFREY OKOYE UNIVERSITY</p>
         <p>Digital Research & Journal Archive</p>
       </HomeText>
       <SearchBar>
        <div className="search_bar">
         <img src="/path/to/search-icon" alt="" />
         <span style={{fontSize: "20px"}}>search research paper ...</span>
         <input type="text" placeholder="Type your search here" style={{height: "30px", borderRadius: "4px", fontSize: "14px"}} />
...
const LatestPublicationHeader = styled.div`
text-align: center;
margin-top: 60px;
margin-bottom: 40px;
padding: 0 20px;
...
const PublishedPapers = styled.div`
display: flex;
align-items: center;
justify-content: center;
gap: 30px;
